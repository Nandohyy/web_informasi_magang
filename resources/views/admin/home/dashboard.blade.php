                                ...
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            <h3 class="font-20">Jumlah Pendaftar</h3>
                                            <h2 class="mb-3 font-18">{{ $totalPendaftar }}
                                            </h2>
                                            <a href="{{ route('admin.view.peserta') }}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                        <div class="banner-img">
                                            <img src="{{ asset('template') }}/assets/img/banner/1.png"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="align-items-center justify-content-between">
                                <div class="row ">
                                    <div
                                        ...
                                        <div class="card-content">
                                            <h3 class="font-20">Jumlah Lowongan</h3>
                                            <h2 class="mb-3 font-18">{{ $totalLowongan }}</h2>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                        <div class="banner-img">
                                            <img src="{{ asset('template') }}/assets/img/banner/3.png"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
